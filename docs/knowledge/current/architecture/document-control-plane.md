...
`docs/graph.yaml` 是统一机器可读来源，替代原来的平面文档清单。登记范围包含根 `README.md`、`AGENTS.md`、`SECURITY.md`，`docs/**/*.md`、项目级 `.agents/skills/**/*.md`，以及作为公开产品资料的 `examples/**/README.md`；因此操作 Skill、安全边界和外部项目指南都进入同一依赖图，而不是藏在文档体系之外。

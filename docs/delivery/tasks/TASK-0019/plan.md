...
1. **Completed** — 固化非 Fake 产品验收与 Task/Backlog/Graph。
2. **Completed** — 实现页面真实任务输入、仓库白名单、Git ref 与 Runtime Root 边界。
3. **Completed** — 接入真实 Codex/Claude Implementation、独立只读 Review 与一次 Finding-driven Repair。
